...
if __name__ == '__main__':
    ...
    parser.add_argument('--meta', action='store_true', default=False,
                        help='Use meta agent path finding')
    ...
    for file in sorted(glob.glob(args.instance)):
        ...
        if args.solver == "CBS":
            ...
            paths, _ = cbs.find_solution(disjoint=args.disjoint, cg_heuristics=args.cg,
                dg_heuristics=args.dg, wdg_heuristics=args.wdg, meta=args.meta)
            results = cbs.get_results()
        ...
        # Edit this to store multiple results
